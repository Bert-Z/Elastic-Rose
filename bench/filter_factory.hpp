...
namespace bench
{
	...
	public:
		...
		static Filter *createFilter(std::vector<std::string> keys,
									u32 num,
									u32 levels,
									u64 bits_per_key,
									std::vector<u64> last_level_bits_per_keys)
		{

			return new FilterElasticRosetta(keys, num, levels, bits_per_key, last_level_bits_per_keys);
		}
		static Filter *createFilter(std::vector<std::string> keys,
									u32 num,
									u32 levels,
