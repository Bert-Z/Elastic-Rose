...
int main(int argc, char *argv[]) {
	...
	&& filter_type.compare(std::string("Rosetta")) != 0
	&& filter_type.compare(std::string("ElasticRosetta")) != 0) {
	...
	if (filter_type.compare(std::string("Rosetta")) == 0)
		...
		filter = bench::FilterFactory::createFilter(insert_keys,insert_keys.size(),level,10,{3,3,3,3});
	else
